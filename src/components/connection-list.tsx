...
export default function ConnectionList() {
    ...
    for (const [id, exit] of Object.entries(overworldExits)) {
        ...
        mappings[key] = <Mapping fromPortal={exit.portal} toPortal={exit.closest?.[1]} bidirectional={bidirectional} />;
    }
    ...
    for (const [id, exit] of Object.entries(netherExits)) {
        ...
        mappings[key] = <Mapping fromPortal={exit.closest?.[1]} toPortal={exit.portal} reverse={true} />;
    }
